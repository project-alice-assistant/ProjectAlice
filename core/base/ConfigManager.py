...
class ConfigManager(Manager):
	...
	def _loadCheckAndUpdateAliceConfigFile(self) -> dict:
		...
		if not configFileExist:
			...
			confs = {configName: configData['defaultValue'] if 'defaultValue' in configData else configData['values'] if 'dataType' in configData and 'dataType' == 'list' else configData for configName, configData in configTemplate.settings.items()}
