...
class ModuleManager(Manager):
	...
	GITHUB_BARE_BASE_URL = 'https://raw.githubusercontent.com/project-alice-assistant/ProjectAliceSkills/master/PublishedModules'
	...
	def checkForModuleUpdates(self, moduleToCheck: str = None) -> bool:
		...
		for moduleName in self._allModules:
			try:
				...
				req = requests.get(f'https://raw.githubusercontent.com/project-alice-assistant/ProjectAliceSkills/{updateSource}/PublishedModules/{availableModules[moduleName]["author"]}/{moduleName}/{moduleName}.install')
