...
class ModulesView(View):
	...
	def toggleModule(self):
		try:
			...
			self.logWarning(f'[Modules] Failed toggling module: {e}')
			return self.index()
	...
	def deleteModule(self):
		try:
			...
			self.logWarning(f'[Modules] Failed deleting module: {e}')
			return self.index()
	...
	def installModule(self):
		try:
			...
			self.logWarning(f'[Modules] Failed installing module: {e}')
