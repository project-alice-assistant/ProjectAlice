...
class TestDialogManager(TestCase):
	...
	def test_new_temp_session(self):
		pass  # Nothing to test()
	...
	def test_cancel_session_timeout(self):
		pass  # Nothing to test()
	...
	def test_forge_user_random_answer(self):
		pass  # Nothing to test()
	...
	def test_toggle_feedback_sound(self):
		pass  # Nothing to test()
	...
	def test_increase_session_timeout(self):
		pass  # Nothing to test()
	...
	def test_sessions_by_sites(self):
		pass  # Nothing to test()


	def test_add_disabled_by_default_intent(self):
		pass  # Nothing to test()


	def test_add_enabled_by_default_intent(self):
		pass  # Nothing to test()


	def test_clean_not_recognized_intent(self):
		pass  # Nothing to test()
